    ...
    try {
      ...
      const drawFrame = () => {
        ...
        if (elapsedSeconds <= animationDuration) {
          ...
          animatedDays = 306 - (progressRatio * (306 - targetDaysRemaining));
        }
      ...
      // Capturer le stream du canvas avec framerate élevé
      const stream = canvas.captureStream(60);
      
      // Essayer MP4 d'abord, sinon WebM avec codec de haute qualité
      let mimeType = 'video/mp4';
      let mediaRecorderOptions: MediaRecorderOptions = {
        mimeType: mimeType,
        videoBitsPerSecond: 12000000, // 12 Mbps pour Full HD
      };
      ...
      mediaRecorderRef.current.onstop = () => {
        ...
        a.download = `school-progress-${new Date().toISOString().split('T')[0]}.${extension}`;
      ...
      // Animer et enregistrer avec durée dynamique
      const animationInterval = setInterval(drawFrame, 16); // ~60 FPS
